...
public class KnightMovesInCircleBoard implements IMove {
	private void LMove(IChessboard board, Piece piece, int newX, int newY, ArrayList<Square> list, boolean ignoreKing) {
		if (newX < 0) {
			newX += 24;
		} else if (newX > 24) {
			newX -= 24;
