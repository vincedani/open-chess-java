...
public class Table {// Table: {two player, one chessboard and x observers}
	...
	public void sendMoveToOther(SClient sender, int beginX, int beginY, int endX, int endY) throws IOException {
		Server.print("running function: sendMoveToOther(" + sender.nick + ", " + beginX + ", " + beginY + ", " + endX
				+ ", " + endY + ")");

		if (sender == clientPlayer1 || sender == clientPlayer2) // only player1
																// and player2
																// can move
		{
