...
import main.java.server.Connection_info;
...
public class Client implements Runnable {
	...
	/*
	 * Method responsible for joining to the server on witch the game was
	 * created
	 */
	...
	public void run() {
		...
		while (isOK) {
			try {
				...
				} else if (in.equals("#settings")) // getting settings from
													// server
				{
					try {
	...
	/*
	 * Method responsible for sending to the server informations about moves of
	 * a player
	 */
