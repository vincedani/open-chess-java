...
public class KnightMovesTest {
	...
	public void setUp() throws Exception {
		...
		knight = pieceFac.GetPieceForSquareBoard(Constants.Symbols.Knight.toString(),Constants.Pieces.Knight.toString(), board, p1);//PieceFactory.createKnightInCircleBoard(board, p1);
